...
class ImagePageViewController: UIPageViewController {
    ...
    private(set) lazy var orderedViewControllers: [UIViewController] = {
        ...
        return [
            self.newColoredViewController("page1"),
            self.newColoredViewController("page2"),
            self.newColoredViewController("page3"),
            self.newColoredViewController("page4"),
            self.newColoredViewController("page5"),
            self.newColoredViewController("page6"),
            self.newColoredViewController("page7"),
            self.newColoredViewController("page8"),
            self.newColoredViewController("page9"),
            self.newColoredViewController("page10")
        ]
    }()
